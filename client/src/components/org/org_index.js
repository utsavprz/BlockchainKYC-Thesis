...
const projectId = '2S2vPAOlDYCitSKCADOvoz6oLDv';   

const projectSecret = 'e23b1dadc955139ce108a057a87e80b3';  
  ...
  render() {
    ...
    if (this.state.loadingorg) {
      ...
      content = validOrg ? (
        ...
        <Container style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", paddingTop: "10px", backgroundColor: "#151833", color: "white", borderRadius: "5px" }}>
          <h2 style={{ color: "white" }}>Only Organization added by admin are allowed</h2>
